...
module Hpricot
  module Node
    ...
    #   t2 = t.subst({
    #     l.get_subnode(0, 'k') => 'v',
    #     l.get_subnode(0, -1) => Hpricot('<a/>'),
    #     l.get_subnode(0, 1) => nil,
    #     l.get_subnode(0, 2, 0) => Hpricot('<b/>'),
    #   })
    #   pp t2
    #   # =>
    #   #<Hpricot::Doc
...
class Hpricot::Location
  ...
  #   p l, l.top
  #   # =>
  #   #<Hpricot::Location: doc()/a/b/c/d>
  #   #<Hpricot::Location: doc()>
  def top
    result = self
    while result.parent
  ...
  #  p l1
  #  l2 = l1.subst_itself(Hpricot('<z/>'))
  #  p l2
  #  t2 = l2.top.to_node
  #  p t2
  #  # =>
  #  #<Hpricot::Doc {elem <a> {elem <b> {elem <c> {emptyelem <d>}}}}>
  #  #<Hpricot::Location: doc()/a/b/c/d>
  #  #<Hpricot::Location: doc()/a/b/c/z>
  #  #<Hpricot::Doc {elem <a> {elem <b> {elem <c> {emptyelem <z>}}}}>
  #
  ...
  #     l.root.get_subnode(-1) => Hpricot('<a/>'),
  #     l.find_element('y') => nil,
  #     l.find_element('z').get_subnode(0) => Hpricot('<b/>'),
  #   })
  #   pp l2, l2.to_node
  #   # =>
  #   #<Hpricot::Doc::Loc: doc()>
  ...
  #   pp l, l.loc_list
  #   # =>
  #   #<Hpricot::Location: doc()/a/b/c>
  #   [#<Hpricot::Location: doc()>,
  #    #<Hpricot::Location: doc()/a>,
  #    #<Hpricot::Location: doc()/a/b>,
  #    #<Hpricot::Location: doc()/a/b/c>]
  #
  def loc_list
    loc = self
  ...
  #
  #   l = Hpricot.parse("<a><b>x</b><b/><a/>").make_loc
...
module Hpricot::Container::Loc
  ...
  def get_subnode_internal(index) # :nodoc:
    ...
    if node
      ...
      @subloc[index] = Hpricot::Location.new(self, index, node)
    end
  end
  ...
  #   l = l.subst_subnode({0=>Hpricot('<z/>')})
  #   pp t, l.top.to_node
  #   # =>
  #   #<Hpricot::Doc {elem <a> {elem <b> {emptyelem <c>}}}>
  #   #<Hpricot::Doc {elem <a> {elem <b> {emptyelem <z>}}}>
  #
