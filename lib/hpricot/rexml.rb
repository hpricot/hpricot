...
#
# Hpricot::Node#to_rexml is used for converting Hpricot to REXML.
#
# == Method Summary
#
# - Hpricot::Node#to_rexml -> REXML::Child
#
# == Example
#
#   Hpricot.parse(...).to_rexml #=> REXML::Document
#
# == Comparison between Hpricot and REXML.
#
# - Hpricot parser is permissive HTML/XML parser.
#   REXML parser is strict XML parser.
#   Hpricot is recommended if you need to parse realworld HTML.
#   REXML is recommended if you need strict error checking.
# - Hpricot object is immutable.
#   REXML object is mutable.
#   REXML should be used if you need modification.
#
require 'hpricot/modules'
require 'hpricot/output' # Hpricot::DocType#generate_content
